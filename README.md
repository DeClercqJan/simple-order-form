...
# basic idea
- order any combination of any quantity of drinks/food and send it via e-mail
- another BeCode PHP challenge

## implementation
- validation: all errors in array
- remember already filled-out form fields within sessin
- remember amount spent across sessiosn
